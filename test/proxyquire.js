...
describe('Given foo requires module bar with bar() that returns "bar" and the path module', function () {
  
  describe('When I resolve foo with original bar as foo and resolve foo with barber stub as foober.', function () {
    before(function () {
